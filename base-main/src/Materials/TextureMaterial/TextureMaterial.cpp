...
void TextureMaterial::setNormalMap(Texture2D *textureNormals) {
    texture_normals = textureNormals;
}

void TextureMaterial::setDiffuseTexture(Texture2D *textureDiffuse) {
    texture_diffuse = textureDiffuse;
}

void TextureMaterial::setPhong(glm::vec3 albedo, glm::vec4 coefficient) {
    param.albedo = albedo;
